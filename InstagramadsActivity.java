...
public class InstagramadsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView selectedPostReact, selectedLike;

    private int postReactionCount = 0, pageLikeCount = 0;
    ...
    private int postReactionCountEx = 0, pageLikeCountEx = 0;
    boolean postReacOld, pageLikeOld;
    String adidOldPostReac, adidOldPageLike;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_instagramads);
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(postReactionCount>0 || pageLikeCount>0){
                    buy();
                }else{
                    Toast.makeText(InstagramadsActivity.this, "Please select something to continue.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void postCounter(){
        counter.setText(postReactionCount+" Reaction(s)");
        double totalprice = postReactionCount * postReactionCost;
        price.setText(""+totalprice);
        buySelector = "post";
    }

    private void pageCounter(){
        counter.setText(pageLikeCount+" Like(s) | ");
            ...
            public void onClick(View v) {
                ...
                if(!etAdUrl.getText().toString().equals("") && !tvLocation.getText().toString().equals("")){
                    ...
                    if(postReactionCount>0){
                        ...
                        if((adurl.contains("instagram.com") && adurl.contains("/p/")) || (adurl.contains("https://instagram.com") && adurl.contains("/p/"))){
                            checkIfOldAddPostLike();
                            adIsValid = true;
                            alertD.cancel();
                        }else{
                            etAdUrl.requestFocus();
                            Toast.makeText(InstagramadsActivity.this, "Not a valid Instagram post! Try again.", Toast.LENGTH_SHORT).show();
                        }
                    }
                    if(pageLikeCount>0){
                        adurl = etAdUrl.getText().toString();
                        ...
                        if((adurl.contains("instagram.com") && !adurl.contains("/p/")) || (adurl.contains("https://instagram.com") && !adurl.contains("/p/"))){
                            checkIfOldAddFollower();
                            adIsValid = true;
                            alertD.cancel();
                        }else{
                            etAdUrl.requestFocus();
                            Toast.makeText(InstagramadsActivity.this, "Not a valid Instagram profile! Try again.", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    Toast.makeText(InstagramadsActivity.this, "Please insert your ad url!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void postBuy(){
        LayoutInflater layoutInflater = LayoutInflater.from(this);
        View promptView = layoutInflater.inflate(R.layout.instagram_post, null);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(!trxId.getText().toString().equals("")||!buyerAccount1.getText().toString().equals("")||!buyerAccount2.getText().toString().equals("")){
                    ...
                    createAd();
//                    Toast.makeText(InstagramadsActivity.this, "Confirmed!", Toast.LENGTH_SHORT).show();
                    new AlertDialog.Builder(InstagramadsActivity.this)
                            .setTitle("Thank you!")
    ...
    private void pageBuy(){
        LayoutInflater layoutInflater = LayoutInflater.from(this);
        View promptView = layoutInflater.inflate(R.layout.instagram_followers, null);
...
//                    Toast.makeText(InstagramadsActivity.this, "Confirmed!", Toast.LENGTH_SHORT).show();
    ...
    private void createAd(){
        ...
        try{
            ...
            if(postReactionCount>0){
                ...
                adcategory = "instagram";
                adtype = "post";
                buyingtype = "instagramlikes";
                    ...
                    for (DataSnapshot adSnap : dataSnapshot.getChildren()) {
                        ...
                        if(oldAd!=null) {
                            if(oldAd.getAdurl().equals(adurl)){
                                if(oldAd.getBuyingtype().equals("instagramlikes")) {
                                    postReacOld = true;
                                    exStatus = "expending";
                                    postReactionCountEx = Integer.parseInt(oldAd.getAdcount());
                                    adidOldPostReac = oldAd.getAdid();
                                    Toast.makeText(InstagramadsActivity.this, "Old Ad", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
            ...
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot adSnap : dataSnapshot.getChildren()) {
                        ...
                        if(oldAd!=null) {
                            if(oldAd.getAdurl().equals(adurl)){
                                if(oldAd.getBuyingtype().equals("instagramfollowers")) {
                                    pageLikeOld = true;
                                    exStatus = "expending";
            ...
            MultiSelectDialog multiSelectDialog = new MultiSelectDialog()
                    ...
                    .onSubmit(new MultiSelectDialog.SubmitCallbackListener() {
                        ...
                        public void onSelected(ArrayList<Integer> selectedIds, ArrayList<String> selectedNames, String dataString) {
                            ...
                            if(reachCounter<postReactionCount || reachCounter<pageLikeCount){
                                tvLocation.setText("any, "+dataString);
                            }

                            Toast.makeText(InstagramadsActivity.this, "Potential Reach: "+reachCounter, Toast.LENGTH_SHORT).show();
                        }
    ...
    void socialLogin(){
        Intent intent = new Intent(InstagramadsActivity.this,SocialLogin.class);
